...
const tabs = [
  {
    id: "diagnostics",
    label: "Diagnostics",
    icon: "/svg/tabs/tab_1.svg",
    icon2: "/svg/tabs/tab_1_blue.svg",
  },
  {
    id: "periodic",
    label: "Periodic Services",
    icon: "/svg/tabs/tab_2.svg",
    icon2: "/svg/tabs/tab_2_blue.svg",
  },
  {
    id: "major",
    label: "Major Repair",
    icon: "/svg/tabs/tab_3.svg",
    icon2: "/svg/tabs/tab_3_blue.svg",
  },
  {
    id: "breakdown",
    label: "Breakdown service",
    icon: "/svg/tabs/tab_4.svg",
    icon2: "/svg/tabs/tab_4_blue.svg",
  },
];
...
export default function CarServiceUI() {
